    ...
    return (
        <Box margin="auto" marginBottom={"100px"}>
            ...
            >
                ...
                <Box marginBottom="20px">
                    ...
                    <Box>
                        ...
                        >
                            <FaGlobe color="white" />
                            <Text paddingLeft={2} color="white">
                                {`${property.website}`}
                            </Text>
                        </Box>
                        <Box
            ...
            >
                ...
                <Text marginBottom="50px" color="white">
                    {property.details}
                </Text>
            </Box>
            <Box
            ...
            >
                ...
                <CountDown title="Voting Ends" time={property.voting} />
                <CountDown title="Decision" time={property.decision} />
                <CountDown
